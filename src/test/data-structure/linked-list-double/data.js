...
const bn = require('./../../../src/data-structure/linked-list-double/source.js'); // benchmark

describe("Double Linked List - Data Tests", function() {
  this.timeout(60000);
  ...
  it ("list should handle random inputs", function() {
    for (let i=0; i<20; i++) {
      ...
      if (JSON.stringify(ds.toArray()) !== JSON.stringify(bn.toArray())) {
        ...
        const p = util.output.write('linked-list-doubly', o);
